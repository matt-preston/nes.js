...
CPU =
{
    ...
    execute: function(aNumberOfCycles)
    {
        ...
        while(_clocksRemain > 0)
        {
            ...
            console.log("PC now at: " + this.context.pc.toString(16));

            var _opcode = Memory.readUnsignedByte(this.context.pc++);

            console.log("Opcode is: " + _opcode);
    ...
    BNE: function()
    {
        ...
        {
            var _relative = Memory.readSignedByte(this.context.pc++);
            this.context.pc += _relative;
        }
        else
        {
            this.context.pc++;
    ...
    LDA: function()
    {
        ...
        this.context.a = Memory.readUnsignedByte(this.context.pc++);
    ...
    {
        // Load X with memory
        this.context.x = Memory.readUnsignedByte(this.context.pc++);
    ...
    {
        // Load Y with memory
        this.context.y = Memory.readUnsignedByte(this.context.pc++);
